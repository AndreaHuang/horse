...
public class StatisticsBackup {
    ...
    private RaceCardItem buildStatistics_Horse_sql(RaceCardItem r) {
        ...
        if(r.getWinOdds() !=0){
            propByWinOdds = Math.log10(0.82/r.getWinOdds());
        }
...
//        dao.runSQL(updateSQL);
    ...
    private void buildStatistics_allRaceCards(String daysOnAfter){
    ...
    public void buildStatistics_allRaceCards(String daysFrom, String daysOnAfter){
        ...
        buildStatistics_draw(daysFrom,daysOnAfter);
    ...
    public void buildStatistics_draw(String startDate, String endDate){
        ...
        dao.runSQL("update racecarddraw d join racecard r on \n" +
                ...
                "set r.drawFx=d.fx " +
                "where r.raceDate >= " +startDate + " and r.raceDate <="+endDate );
