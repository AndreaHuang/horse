...
public class RaceCardRowMapper implements RowMapper<RaceCardAnalysis> {
    @Override
    public RaceCardAnalysis mapRow(ResultSet resultSet, int i) throws SQLException {
        RaceCardAnalysis r = new RaceCardAnalysis();

        r.setRateDate(resultSet.getString("rateDate"));
